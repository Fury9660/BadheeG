...
export default function ApprovalPendingScreen() {
    ...
    const { refreshPartnerStatus } = useAuth();
            ...
            >
                <SafeAreaView style={styles.content}>
                    <View style={[styles.card, { backgroundColor: theme.secondary, borderColor: theme.border }]}>
                        ...
                        <TouchableOpacity
                            style={[styles.button, { backgroundColor: theme.primary, shadowColor: theme.primary, marginBottom: 12 }]}
                            onPress={async () => {
                                await refreshPartnerStatus();
                                router.replace('/'); // Trigger a re-evaluation
                            }}
                        >
                        ...
                        >
                            <Text style={styles.buttonText}>Logout & Back to Home</Text>
                        </TouchableOpacity>
