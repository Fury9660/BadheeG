...
const PartnerWebSidebar = () => {
    ...
    const menuItems = [
        { label: 'Dashboard', route: '/partners/(tabs)/dashboard', icon: 'view-dashboard', library: MaterialCommunityIcons },
        { label: 'Orders', route: '/partners/(tabs)/orders', icon: 'clipboard-list', library: MaterialCommunityIcons },
        { label: 'Catalog', route: '/partners/(tabs)/inventory', icon: 'cube', library: MaterialCommunityIcons },
        { label: 'Finance', route: '/partners/(tabs)/finance', icon: 'wallet', library: MaterialCommunityIcons },
    ...
    const isActive = (route: string) => {
        if (route === '/partners/(tabs)/dashboard' && (pathname === '/partners' || pathname === '/partners/')) return true;
