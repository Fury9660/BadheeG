...
const AddAddressScreen = () => {
    ...
    const handleSaveAddress = async () => {
        ...
        if (!form.name || !form.mobile || !form.pincode || !form.line1 || !form.city || !form.state) {
        ...
        try {
            ...
            Alert.alert("Error", "Could not save address: " + e.message);
        }
    };
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.background, paddingTop: insets.top }]}>
            ...
            <View style={[styles.footer, { paddingBottom: insets.bottom + 8, backgroundColor: theme.card }]}>
                <TouchableOpacity style={[styles.saveButton, { backgroundColor: theme.primary }]} onPress={handleSaveAddress}>
