        ...
        <View style={[styles.container, { backgroundColor: isDarkMode ? '#0A0A0A' : '#F8FAFC' }]}>
            ...
            <View style={[styles.topBar, { paddingTop: insets.top + 10 }]}>
                ...
                <View style={styles.headerTitleGroup}>
                    <Text style={[styles.headerTitle, { color: theme.text }]}>{id ? 'Edit Product' : 'New Product'}</Text>
                    <View style={styles.dot} />
                    <Text style={styles.headerSubTitle}>{id ? 'Update Details' : 'Creation'}</Text>
                </View>
                <View style={{ width: 44 }} />
            </View>
...
const styles = StyleSheet.create({
    ...
    backBtn: { width: 44, height: 44, borderRadius: 15, backgroundColor: 'rgba(0,0,0,0.02)', alignItems: 'center', justifyContent: 'center' },
    headerTitleGroup: { flexDirection: 'row', alignItems: 'center', gap: 10 },
    headerTitle: { fontSize: 22, fontWeight: '900', letterSpacing: -0.5 },
    dot: { width: 5, height: 5, borderRadius: 2.5, backgroundColor: '#CBD5E1', marginTop: 4 },
    headerSubTitle: { fontSize: 18, fontWeight: '500', color: '#64748B' },
