        ...
        <View style={[styles.contentWrapper, { maxWidth: 480, alignSelf: 'center', width: '100%' }]}>
          ...
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            <View style={styles.infoRow}>
              ...
              <Text style={[styles.value, { color: colors.text }]}>{userData?.owner_name || 'Loading...'}</Text>
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.valueContainer}>
                <Text style={[styles.value, { color: colors.text }]}>{userData?.mobile_number || 'Not Set'}</Text>
          ...
          <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
            ...
            {!otpSent ? (
              ...
              <>
                ...
                />
                <View style={styles.modalButtons}>
                  <TouchableOpacity style={[styles.button, styles.cancelBtn, { borderColor: colors.border }]} onPress={() => { setPhoneModalVisible(false); setOtpSent(false); }}>
                    <Text style={[styles.buttonText, { color: colors.text }]}>Cancel</Text>
                  </TouchableOpacity>
