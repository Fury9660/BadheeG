...
const ProductDetailsScreen = () => {
    ...
    const product = {
        ...
        image: params.image as string || Asset.fromModule(productImages[0]).uri,
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <ImageViewing
                images={productImages.map(img => ({ uri: Asset.fromModule(img).uri }))}
...
const styles = StyleSheet.create({
    ...
    imageContainer: { width: width, height: IMAGE_HEIGHT, backgroundColor: '#fff' },
