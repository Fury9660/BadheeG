...
const AddAddressScreen = () => {
    ...
    const handleSaveAddress = async () => {
        ...
        if (!form.name.trim() || !form.mobile.trim() || !form.line1.trim() || !form.pincode.trim()) {
            return Alert.alert("Required Fields", "Please fill in all mandatory fields.");
        }
            ...
            <View style={[
                ...
                <TextInput
                    ...
                    onChangeText={text => {
                        ...
                        else setForm(prev => ({ ...prev, [key]: text }));
                    }}
    ...
    return (
        ...
        >
            ...
            <View style={[styles.header, { paddingTop: insets.top + 20, borderBottomColor: theme.border }]}>
                ...
                <Text style={[styles.headerTitle, { color: theme.text }]}>New Address</Text>
                <View style={{ width: 24 }} />
            </View>
            ...
            >
                ...
                <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.border }]}>
                    ...
                    {renderInput("Address Line 1 (House No, Building)", "line1")}
                    {renderInput("Address Line 2 (Area, Locality)", "line2")}
